                          ...
                          <div class="collapse navbar-collapse" id="navbarNav">
                              <ul class="navbar-nav d-flex justify-content-left align-items-center py-1">
                                  ...
                                  <li class="{{'parteneri'== request()->path() ? 'active':''}}">
                                    <a class="nav-link" href="{{route('pages','parteneri')}}"> Reports </a>
                                  </li>
            ...
            <div class="row">
                <aside class="col-sm-3  col-md-3 white">
                    ...
                    <ul class="list-unstyled">
                        <li> <a class="nav-link" href="{{ route('login') }}"> Logare client </a></li>
                        <li> <a class="nav-link" href="{{route('register')}}"> &#206;nregistrare </a></li>
